      ...
      <Card className="bg-gradient-to-r from-primary/10 to-chart-3/10 border-primary/20">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            RESYNC Studios is constantly evolving. This site is just the beginning of what we want to achieve. 
            With a solid foundation in place, we can focus on bigger features that will shape the future of our community. 
            Thank you for your support throughout this journey. We are just getting started, and the best parts are still ahead.
          </p>
        </CardContent>
      </Card>
    </div>
