...
const stats = [
  ...
  { value: 98, label: "Active Discussions", suffix: "+" },
...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "[RS Clans] Access to Create Clans",
      "+ 13 more benefits",
    ],
  },
  {
    ...
    price: 35.99,
    features: [
      "[RS Features] All features from Bronze and Diamond, plus:",
      "[RS Moderation Team] Exclusive access to the T&S discord server",
      "[RS Game Features] Exclusive access to in-game functions and commands",
      "[RS Discord Server] Exclusive Role, Less Chat Restrictions",
      "[RS Discord Server] Post Images / Videos / Files",
  ...
  {
    name: "Founder's Edition Lifetime®",
    price: 64.99,
    features: [
      "[RS Features] All features from Bronze, Diamond and Founder's VIP, plus:",
      "[RS Moderation Team] Exclusive access to the T&S discord server",
      "[RS Game Features] Exclusive access to in-game functions and commands",
      "[RS Discord Server] Exclusive Role, Less Chat Restrictions, Less @mention Restrictions",
      "[RS Discord Server] Post Images / Videos / Files",
      "[RS Discord Server] Send Messages in Ventura Teasers",
      "[RS HelpDesk] Urgent Priority Ticket Support",
      "[RS Moderation] Urgent Priority Appeals and Player Reports",
      "+ 15 more benefits",
    ],
